<script type="text/javascript" src="{L_ABBC_JS}"></script>
<script type="text/javascript" src="mods/bbcode_box/js/jscolor.js"></script>
<script type="text/javascript" src="mods/bbcode_box/js/jquery.autogrowtextarea.js"></script>
<script type="text/javascript" src="mods/bbcode_box/js/textarea-settings.js"></script>
...
<img src="images/transparent.gif" class="postimage bbc-inactive" id="abbctwitter" onclick="BBCtwitter()" onmouseover="helpline('abbctwitter')" alt="" />
<img src="images/transparent.gif" class="box-blackdot" alt="" />
