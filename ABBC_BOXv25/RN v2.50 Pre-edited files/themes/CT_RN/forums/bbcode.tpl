...
<tr>
<td><span class="uppercase">{L_CODE}:<script type="text/javascript" src="{U_SXBB_JSLIB}"></script><script type="text/javascript">
   var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
   SXBB[id] = new _SXBB(id);
   SXBB[id].T['select'] = '{L_SELECT}';
   SXBB[id].T['expand'] = '{L_EXPAND}';
   SXBB[id].T['contract'] = '{L_CONTRACT}';
   SXBB[id].writeCmd();
</script></span><script type="text/javascript">SXBB[id].writeDiv();</script><pre><code class="codestyle"><!-- END code_open -->
<!-- BEGIN code_close --></code></pre><script type="text/javascript">document.write('<\/div>');</script></td>
</tr>
</table><!-- END code_close -->

<!-- BEGIN pre_open --><table class="codetable">
<tr>
<td><span class="uppercase">{PRECLASS} {ITS_CODE}:<script type="text/javascript" src="{U_SXBB_JSLIB}"></script><script type="text/javascript">
   var id = 'SXBB' + (1000 + Math.floor(Math.random() * 5000));
   SXBB[id] = new _SXBB(id);
   SXBB[id].T['select'] = '{L_SELECT}';
   SXBB[id].T['expand'] = '{L_EXPAND}';
   SXBB[id].T['contract'] = '{L_CONTRACT}';
   SXBB[id].writeCmd();
</script></span><script type="text/javascript">SXBB[id].writeDiv();</script><pre class="language-{PRECLASS}"><code class="codestyle"><!-- END pre_open -->
<!-- BEGIN pre_close --></code></pre><script type="text/javascript">document.write('<\/div>');</script></td>
</tr>
</table><!-- END pre_close -->
...
<!-- BEGIN duck --><a class="postlink duck ficon IBmodal" href="http://duckduckgo.com/?q={QUERY}">{STRING}</a><!-- END duck -->
